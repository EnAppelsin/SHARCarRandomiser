...
function P3D.LightIlluminationTypeP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	chunk.IlluminationType = string_unpack(Endian .. "I", chunk.ValueStr)
...
function P3D.LightIlluminationTypeP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIII", self.Identifier, headerLen, headerLen + #chunkData, self.IlluminationType) .. chunkData
end