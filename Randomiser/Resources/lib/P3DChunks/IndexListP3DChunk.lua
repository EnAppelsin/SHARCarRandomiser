...
function P3D.IndexListP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.IndexListP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIII" .. string_rep("I", indicesN), self.Identifier, headerLen, headerLen + #chunkData, indicesN, table_unpack(self.Indices)) .. chunkData
end