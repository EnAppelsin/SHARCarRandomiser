...
function P3D.CompositeDrawableEffectListP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.CompositeDrawableEffectListP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIII", self.Identifier, headerLen, headerLen + #chunkData, self:GetNumElements()) .. chunkData
end