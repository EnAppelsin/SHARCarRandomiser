...
function P3D.AnimationGroupP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	chunk.Version, chunk.Name, chunk.GroupId = string_unpack(Endian .. "Is1I", chunk.ValueStr)
...
function P3D.AnimationGroupP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIIs1II", self.Identifier, headerLen, headerLen + #chunkData, self.Version, Name, self.GroupId, chunkN) .. chunkData
end