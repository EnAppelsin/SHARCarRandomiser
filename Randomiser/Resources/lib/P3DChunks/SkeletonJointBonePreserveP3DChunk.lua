...
function P3D.SkeletonJointBonePreserveP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	chunk.PreserveBoneLengths = string_unpack(Endian .. "I", chunk.ValueStr)
...
function P3D.SkeletonJointBonePreserveP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIII", self.Identifier, headerLen, headerLen + #chunkData, self.PreserveBoneLengths) .. chunkData
end