...
function P3D.GameAttrP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.GameAttrP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1II", self.Identifier, headerLen, headerLen + #chunkData, Name, self.Version, #self.Chunks) .. chunkData
end