...
function P3D.SetP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.SetP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1IB", self.Identifier, headerLen, headerLen + #chunkData, Name, self.Version, self:GetNumTextures()) .. chunkData
end