...
function P3D.FrontendTextBibleP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.FrontendTextBibleP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1Is1", self.Identifier, headerLen, headerLen + #chunkData, Name, num, languages) .. chunkData
end