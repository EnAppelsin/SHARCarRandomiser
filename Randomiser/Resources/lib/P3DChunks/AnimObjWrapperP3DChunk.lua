...
function P3D.AnimObjWrapperP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	chunk.Name, chunk.Version, chunk.HasAlpha = string_unpack(Endian .. "s1BB", chunk.ValueStr)
...
function P3D.AnimObjWrapperP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1BB", self.Identifier, headerLen, headerLen + #chunkData, Name, self.Version, self.HasAlpha) .. chunkData
end