...
function P3D.IntersectMeshP3DChunk:parse(Endian, Contents, Pos, DataLength)
...
function P3D.IntersectMeshP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1I", self.Identifier, headerLen, headerLen + #chunkData, Name, self:GetNumIntersectMesh2s()) .. chunkData
end