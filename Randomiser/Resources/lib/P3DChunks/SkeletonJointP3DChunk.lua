...
function P3D.SkeletonJointP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIs1Iiiiiiffffffffffffffff", self.Identifier, headerLen, headerLen + #chunkData, Name, self.Parent, self.DOF, self.FreeAxis, self.PrimaryAxis, self.SecondaryAxis, self.TwistAxis, self.RestPose.M11, self.RestPose.M12, self.RestPose.M13, self.RestPose.M14, self.RestPose.M21, self.RestPose.M22, self.RestPose.M23, self.RestPose.M24, self.RestPose.M31, self.RestPose.M32, self.RestPose.M33, self.RestPose.M34, self.RestPose.M41, self.RestPose.M42, self.RestPose.M43, self.RestPose.M44) .. chunkData
end