...
function P3D.AnimationHeaderP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	local pos
	chunk.Version, chunk.NumGroups, pos = string_unpack(Endian .. "II", chunk.ValueStr)
...
function P3D.AnimationHeaderP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIII", self.Identifier, headerLen, headerLen + #chunkData, self.Version, self.NumGroups) .. chunkData
end