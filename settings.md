...
*This requires a small one-off bit of extra work, detailed in [this documentation](RandomDialogue.html)*
...
*Adding additional cars requires extra work, detailed in [this documentation](CustomCars)*
#### Random pedestrians
On by default.  
